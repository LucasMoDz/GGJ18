...
////// Lighting:
////// Emissive:
                float4 node_5662 = _Time + _TimeEditor;
                float2 node_8283 = (i.uv0+node_5662.g*float2(0,-0.2));
                float node_9083 = 1.0;
                ...
                float3 node_2497 = (_Color.rgb*_AdditiveFactor*node_5964*i.vertexColor.rgb); // Decide final color
                float3 emissive = node_2497;
