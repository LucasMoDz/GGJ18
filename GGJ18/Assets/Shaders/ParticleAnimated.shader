...
////// Emissive:
                ...
                float node_7661 = 1.0;
                float4 _Pattern1_var = tex2Dlod(_Pattern1,float4(TRANSFORM_TEX(node_1554, _Pattern1),0.0,node_7661));
                float4 node_3532 = _Time + _TimeEditor;
                float2 node_1963 = (i.uv0+(node_3532.g*float2(_OffsetSpeed.b,_OffsetSpeed.a))); // Panning UVs
                float4 _Pattern2_var = tex2Dlod(_Pattern2,float4(TRANSFORM_TEX(node_1963, _Pattern2),0.0,node_7661));
                float4 _Alpha_var = tex2Dlod(_Alpha,float4(TRANSFORM_TEX(i.uv0, _Alpha),0.0,node_7661));
                float node_5964 = (i.vertexColor.a*_Pattern1_var.a*_Pattern2_var.a*_Alpha_var.a); // Multiply all alphas
                float3 emissive = (_Color.rgb*node_5964*_AdditiveFactor*i.vertexColor.a*i.vertexColor.rgb);
